#include "../EsdCppApp/EsdCppApp.h"  // Include the header file for the EsdApp class and related functionality.
...
#define TITLE "Esd.CppAppExample"  // Define the title of the application window.
