...
namespace EsdCppApp
{
    ...
    void EsdImGuiLayer::RunFrame(void(*userAppUI)(), bool& isActive)
    {
        ...
        ImGui::Begin(title, &isActive, ImGuiWindowFlags_NoDocking);

        // Create a DockSpace node where other windows can dock
    ...
    void EsdImGuiLayer::DefaultEsdStyle()
    {
        ...
        io.Fonts->Clear();
        io.Fonts->AddFontFromMemoryTTF(VerdanaFontData, 149752, 16.0f, NULL);
        io.Fonts->Build();
        ...
        style.TabRounding = 0.0f;  // Make the tabs have squared corners
        ...
        style.Colors[ImGuiCol_TabActive]              = style.Colors[ImGuiCol_TitleBgActive];
